...
public class InfoManager : IInfoManager
{
    ...
    public string HelpText => $"""
                            ...
                            🔘 Нове речення 🆕 - не потрібно шукати фрази самостійно. Додаток запропонує нові речення для вивчення, щоб ви могли одразу зануритися в практику. Більш детально /{CommandField.HelpNewSentences}
