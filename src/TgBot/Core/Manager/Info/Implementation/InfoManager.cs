...
public class InfoManager : IInfoManager
{
    ...
    public string HelpChatText => $"""
                                  ...
                                  🔘 Натисніть *{SmallTalkChatField.SearchNewUserKeyboard}*, щоб знайти партнера для спілкування. Після цього надішліть привітальне повідомлення і почніть спілкування. Спілкуватися можна тільки англійською.
                                  ...
                                  """;
                                  // ❌ *Обмеження*: можна надіслати до 35 повідомлень на день і зробити до 6 запитів на аналіз.
