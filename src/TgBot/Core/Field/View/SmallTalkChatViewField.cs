...
public class SmallTalkChatViewField
{
    public const string StartSmallTalkChatAction = nameof(StartSmallTalkChatAction);
    public const string SearchNewUserKeyboard = nameof(SearchNewUserKeyboard);
    public const string SearchNewUserSuccessfulResult = nameof(SearchNewUserSuccessfulResult);
    public const string SearchNewUserBadResult = nameof(SearchNewUserBadResult);
